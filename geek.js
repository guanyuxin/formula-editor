...
var keys=[
    ...
    {title:"corner",data:CornerExp,des:"插入角标"},

    {title:"alpha",data:"Α",des:"希腊字母:阿尔法"},
    {title:"beta",data:"Β",des:"希腊字母:贝塔"},
    {title:"gamma",data:"Γ",des:"希腊字母:伽马"},
    {title:"delta",data:"Δ",des:"希腊字母:德尔塔"},
    {title:"epsilon",data:"Ε",des:"希腊字母:伊普西龙"},
    {title:"zeta",data:"Ζ",des:"希腊字母:截塔"},
    {title:"eta",data:"Η",des:"希腊字母:艾塔"},
    {title:"thet",data:"Θ",des:"希腊字母:西塔"},
    {title:"iot",data:"Ι",des:"希腊字母:约塔"},
    {title:"kappa",data:"Κ",des:"希腊字母:卡帕"},
    {title:"lambda",data:"Λ",des:"希腊字母:兰布达"},
    {title:"mu",data:"Μ",des:"希腊字母:缪"},
    {title:"nu",data:"Ν",des:"希腊字母:纽"},
    {title:"xi",data:"Ξ",des:"希腊字母:克西"},
    {title:"omicron",data:"Ο",des:"希腊字母:奥密克戎"},
    {title:"pi",data:"Π",des:"希腊字母:派"},
    {title:"rho",data:"Ρ",des:"希腊字母:肉"},
    {title:"sigma",data:"Σ",des:"希腊字母:西格马"},
    {title:"tau",data:"Τ",des:"希腊字母:套"},
    {title:"upsilon",data:"Υ",des:"希腊字母:宇普西龙"},
    {title:"phi",data:"Φ",des:"希腊字母:佛爱"},
    {title:"chi",data:"Χ",des:"希腊字母:西"},
